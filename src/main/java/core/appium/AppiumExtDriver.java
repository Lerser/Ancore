 ...
 */
// TODO: Доделать разделение под иось
public class AppiumExtDriver extends AppiumDriver implements FindsByAndroidUIAutomator, FindsByIosUIAutomaton {
...
//            driver = new AppiumExtDriver(new UrlFactory().createUrl(), MobileCapabilitiesFactory.getCapabilities(platform));
    ...
    public void scrollToText(WebElement element, String text) {
